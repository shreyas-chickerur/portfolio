    ...
    return (
        <div class={Row}>
            <div class={TripleColumnOne}>
                <h2 class = { columnHeader }>Work</h2>
                <p class = { columnBody }>I'm currently a senior at Purdue University majoring in Computer Science, Data Science, and Applied Statistics.</p>
            </div>
